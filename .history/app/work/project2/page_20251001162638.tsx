...
export default function Project1Page() {
  return (
    <div className="px-6 py-10 max-w-6xl mx-auto">
      ...
      {/* Pinpoints → ▼ → Solutions (열 단위로 묶어서 사이에 배치) */}
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-stretch">
        {[
          {
            pTitle: "Pinpoint 01",
            pBody:
              "Hard to feel immediate value because a large number of points is required before rewards.",
            sTitle: "Solution 01",
            sBody:
          ...
          {
            pTitle: "Pinpoint 02",
            pBody: "Monotonous participation methods (step counter, ads).",
            sTitle: "Solution 02",
            sBody:
          ...
          {
            pTitle: "Pinpoint 03",
            pBody: "Complex UI and unfamiliar technical jargon.",
            sTitle: "Solution 03",
            sBody:
          ...
          {
            pTitle: "Pinpoint 04",
            pBody: "Users lose interest after short-term use.",
            sTitle: "Solution 04",
            sBody:
              "Strengthen immediacy of rewards to maximize short-term motivation.",
          },
        ].map((col) => (
          <div key={col.pTitle} className="flex flex-col items-center h-full">
            {/* Pinpoint 박스 */}
            <div className="rounded-2xl bg-white shadow-sm ring-1 ring-black/5 p-6 text-center h-full flex flex-col justify-center">
              <p className="text-sm font-semibold text-gray-500 mb-2">
                {col.pTitle}
              </p>
              <p className="text-gray-800">{col.pBody}</p>
            </div>

            {/* ▼ 삼각형 */}
            <div
              aria-hidden
              className="my-3 w-0 h-0 flex-shrink-0 border-l-[12px] border-r-[12px] border-l-transparent border-r-transparent border-t-[16px] border-t-sky-500"
            />
            ...
            <div className="rounded-2xl bg-white shadow-sm ring-1 ring-black/5 p-6 text-center h-full flex flex-col justify-center">
              ...
              <p className="text-gray-800">{col.sBody}</p>
            </div>
          </div>
        ))}
      </div>
