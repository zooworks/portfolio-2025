...
export default function Project1Page() {
  return (
    <div className="px-6 py-10 max-w-6xl mx-auto">
            ...
            <div key={idx} className="flex flex-col items-center">
              ...
              <div
                className="rounded-2xl bg-white shadow-sm ring-1 ring-black/5
                        p-4 md:p-6 text-center flex flex-col justify-center
                        min-h-0 md:min-h-[240px] leading-normal"
              >
                <p className="text-xs md:text-sm font-semibold text-gray-500 mb-2">
                  {item.title}
                </p>
                <p className="text-[15px] md:text-base text-gray-800">
                  {item.body}
                </p>
              </div>
              ...
              <div
                aria-hidden
                className="my-2 md:my-3 w-0 h-0 flex-shrink-0
                     border-l-[10px] md:border-l-[12px]
                     border-r-[10px] md:border-r-[12px]
                     border-l-transparent border-r-transparent
                     border-t-[14px] md:border-t-[16px] border-t-sky-500"
              />
              ...
              <div
                className="rounded-2xl bg-white shadow-sm ring-1 ring-black/5
                        ...
                        min-h-0 md:min-h-[240px] leading-normal"
              >
                <p className="text-[11px] md:text-xs font-semibold text-sky-600 mb-2 md:mb-3">
                  {item.solutionTitle}
                </p>
      ...
      <section className="mt-20">
        ...
        {/* Solution */}
       <div className="mb-16">
  <p className="text-base text-gray-700 mb-8 md:mb-12">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 items-stretch">
    {[
      { title: "Simplicity",  body: "Minimize steps, make minting as easy as a camera click." },
      { title: "Familiarity", body: "Use patterns users already know (camera UI, reward systems)." },
      { title: "Engagement",  body: "Add gamification and social feedback loops to keep users active." },
    ].map((c) => (
      <div
        key={c.title}
        className="rounded-2xl bg-white ring-1 ring-black/5 shadow-sm
                   p-5 md:p-6 flex flex-col items-center justify-center
                   text-center min-h-0 md:min-h-[360px]"
      >
        <div className="w-56 h-56 md:w-60 md:h-60 rounded-full border-2 border-gray-300
                        flex flex-col items-center justify-center bg-white px-4">
          <h3 className="font-bold text-lg mb-1">{c.title}</h3>
          <p className="text-sm text-gray-500 leading-snug">{c.body}</p>
        </div>
      </div>
    ))}
  </div>
