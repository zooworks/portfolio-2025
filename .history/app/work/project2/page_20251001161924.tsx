...
export default function Project1Page() {
  return (
    <div className="px-6 py-10 max-w-6xl mx-auto">
      ...
      {/* 3.1 Pinpoints → Solutions → Service Goal */}
      <div className="mt-10 space-y-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            ...
            <div
              key={p.title}
              className="rounded-2xl bg-white shadow-sm ring-1 ring-black/5 p-6 text-center flex flex-col items-center"
            >
              <p className="text-sm font-semibold text-gray-500 mb-2">
                {p.title}
              </p>
              <p className="text-gray-800">{p.body}</p>
              <span className="mt-4 text-blue-400" aria-hidden>
                ▼
              </span>
            </div>
          ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            {
              title: "Solution 01",
              body: "Provide instant rewards even with small point amounts (e.g., low-value gift cards).",
              icon: (
                <svg
                  width="40"
                  height="40"
            ...
            {
              title: "Solution 02",
              body: "Offer diverse missions such as location-based tasks, challenges, and shopping verification.",
              icon: (
                <svg
                  width="40"
                  height="40"
            ...
            {
              title: "Solution 03",
              body: "Simplify the verify-and-earn UX; present NFTs in an experience-focused way rather than technical terms.",
              icon: (
                <svg
                  width="40"
                  height="40"
            ...
            {
              title: "Solution 04",
              body: "Strengthen immediacy of rewards to maximize short-term motivation.",
              icon: (
                <svg
                  width="40"
                  height="40"
        ...
        {/* Service Goal */}
        <div className="bg-blue-50/70 border border-blue-200 rounded-2xl p-6 text-center">
          <p className="text-blue-600 font-semibold mb-1">Service Goal</p>
