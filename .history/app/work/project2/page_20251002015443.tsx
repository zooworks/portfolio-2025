        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-stretch">
          {[
            ...
            <div key={idx} className="flex flex-col w-full">
              {/* Pinpoint 카드 */}
              <div className="w-full max-w-[360px] md:max-w-none mx-auto rounded-2xl bg-white border border-gray-200 p-6 text-center flex flex-col justify-start min-h-[200px] md:min-h-[240px]">
