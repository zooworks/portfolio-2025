      ...
      <section className="mt-16">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:gap-8">
          ...
          <div className="md:w-[480px]">
            <h3 className="text-sm font-semibold text-gray-500 mb-3 text-center md:text-left">
              Problems
            </h3>

            <div className="relative rounded-full border border-emerald-500 bg-white px-6 py-6 md:px-8 md:py-7">
              <div className="flex items-center justify-between gap-3 md:gap-6">
                {/* problem 1 */}
                <div
                  className="grid place-items-center rounded-full border-2 border-dashed border-emerald-400 bg-white
                          w-24 h-24 md:w-28 md:h-28 text-sm text-gray-600"
                >
                  동기부족
                </div>
                {/* problem 2 */}
                <div
                  className="grid place-items-center rounded-full border-2 border-dashed border-emerald-400 bg-white
                          w-24 h-24 md:w-28 md:h-28 text-sm text-gray-600 text-center leading-snug px-2"
                >
                  개인화된
                  <br />
                  피드백 부족
          ...
          {/* --------- Connector line (desktop만 보이게) --------- */}
          <div className="hidden md:block flex-1">
            <div className="h-0.5 w-full bg-emerald-400/70 rounded-full" />
          </div>

          {/* -------------------- Right : Solution big circle -------------------- */}
          <div
            className="mx-auto mt-8 md:mt-0 relative
                    w-[520px] h-[520px] md:w-[620px] md:h-[620px]
                    rounded-full border border-emerald-500"
          >
            <div className="absolute -top-8 left-1/2 -translate-x-1/2 text-sm text-gray-600">
              Solution
            </div>
            ...
            <div
              className="absolute left-1/2 top-1/2 -translate-x-[58%] -translate-y-1/2
                      ...
                      rounded-full border-2 border-dashed border-emerald-400 grid place-items-center"
            >
              <span className="text-3xl font-extrabold tracking-wide text-gray-800">
                HABIT
              </span>
            </div>
            ...
            {/* GAME circle */}
            <div
              className="absolute left-1/2 top-1/2 -translate-x-[-2%] -translate-y-[8%]
                      w-[300px] h-[300px] md:w-[340px] md:h-[340px]
                      rounded-full border-2 border-dashed border-emerald-400 grid place-items-center"
            >
              <span className="text-3xl font-extrabold tracking-wide text-gray-800">
                GAME
            ...
            {/* AI circle */}
            <div
              className="absolute left-1/2 top-1/2 -translate-x-[8%] -translate-y-[62%]
                      w-[300px] h-[300px] md:w-[340px] md:h-[340px]
                      rounded-full border-2 border-dashed border-emerald-400 grid place-items-center"
            >
              <span className="text-3xl font-extrabold tracking-wide text-gray-800">
