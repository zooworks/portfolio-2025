...
export default function Project1Page() {
 ...
 <section className="mt-16 text-center">
  ...
  <div className="relative flex justify-center items-center">
    {/* Solution (가장 바깥 원) */}
    <div className="w-80 h-80 rounded-full bg-green-100 absolute flex flex-col justify-center items-center p-6">
    ...
    {/* Insight (중간 원) */}
    <div className="w-60 h-60 rounded-full bg-purple-100 absolute flex flex-col justify-center items-center p-6">
    ...
    {/* Problem (가장 안쪽 원) */}
    <div className="w-40 h-40 rounded-full bg-red-100 flex flex-col justify-center items-center p-6">
