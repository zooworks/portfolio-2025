  ...
  return (
    <div className="px-6 py-10 max-w-6xl mx-auto">
      ...
      <section className="mt-16">
        ...
        <div className="rounded-2xl bg-[#6736FF] text-white text-center px-6 py-4 font-semibold shadow-sm max-w-3xl mx-auto">
      ...
      <section className="mt-16">
        <h2 className="text-2xl font-bold mb-12">2. Desk Research</h2>
