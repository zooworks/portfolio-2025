      ...
      <section className="mt-12 overflow-hidden">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-stretch">
          {[
            ...
            {
              title: "Pinpoint 04",
              body: "Users disengage after short-term use because interactions feel repetitive and the product doesn’t convert early incentives into sustainable habits.",
