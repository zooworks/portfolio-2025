        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-stretch">
          {[
            ...
            <div key={idx} className="flex flex-col items-center w-full">
              {/* Pinpoint 카드 */}
              <div className="w-full rounded-2xl bg-white shadow-sm ring-1 ring-black/5 p-6 text-center flex flex-col justify-center min-h-[200px] md:min-h-[240px] leading-snug">
              ...
              {/* Solution 카드 */}
              <div className="w-full rounded-2xl bg-white shadow-sm ring-1 ring-black/5 p-6 text-center flex flex-col justify-center min-h-[200px] md:min-h-[240px]">
