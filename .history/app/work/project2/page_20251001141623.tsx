    ...
    <div className="px-6 py-10 max-w-6xl mx-auto">
      ...
      <section className="mt-16 ">
        ...
        <p className="text-base text-gray-700 mb-20">
          In the JjikgoMoney project, I was responsible for designing the
          onboarding flow and mission structures. I planned the photo
          verification process to be stored as NFTs, ensuring the reliability of
          user records and guaranteeing digital ownership. To make the complex
          reward system accessible even for first-time users, I simplified it
          into a clear and intuitive experience. In addition, I designed diverse
          participation scenarios such as map-based missions, free missions,
          challenge missions, and shopping verification missions. These
          variations allowed users to naturally integrate the app into their
          daily routines and choose the type of engagement that best matched
          their lifestyle.
        </p>
      ...
      <section className="mt-20">
        <h2 className="text-2xl font-bold mb-4">3. Why NFTCAM?</h2>
