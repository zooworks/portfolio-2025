    ...
    <div className="px-6 py-10 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-10 items-stretch">
        {[
          ...
          <div key={col.pTitle} className="flex flex-col items-center">
            {/* Pinpoint */}
            <div className="rounded-2xl bg-white shadow-sm ring-1 ring-black/5 p-6 text-center flex-1 flex flex-col justify-center">
