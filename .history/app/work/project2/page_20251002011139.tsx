...
/* === helper icons (모바일 정렬 안정화용) === */
const IconSquares = () => (
  <div className="flex justify-center items-center gap-2 leading-none">
    {Array.from({ length: 4 }).map((_, i) => (
      <span
        key={i}
        className="inline-block w-4 h-4 md:w-5 md:h-5 bg-black rounded-[2px]"
        aria-hidden
      />
    ))}
  </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-stretch">
          {[
            ...
            <div key={idx} className="flex flex-col items-center w-full">
              {/* Pinpoint 카드 */}
              <div className="w-full rounded-2xl bg-white shadow-sm ring-1 ring-black/10 p-6 text-center flex flex-col justify-center min-h-[200px] md:min-h-[240px] leading-snug">
              ...
              {/* Solution 카드 */}
              <div className="w-full rounded-2xl bg-white shadow-sm ring-1 ring-black/10 p-6 text-center flex flex-col justify-center min-h-[200px] md:min-h-[240px]">
