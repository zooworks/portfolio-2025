    ...
    <div className="px-6 py-10 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-10">
        {[
          ...
          <div key={col.pTitle} className="flex flex-col items-center gap-4">
            {/* Pinpoint card */}
            <div className="rounded-2xl bg-white shadow-sm ring-1 ring-black/5 p-6 text-center flex flex-col items-center">
            ...
            <div
              aria-hidden
              className="w-0 h-0 border-l-[10px] border-r-[10px] border-l-transparent border-r-transparent border-t-[14px] border-t-sky-500"
            />
