...
export default function Project1Page() {
  return (
    <div className="px-6 py-10 max-w-6xl mx-auto">
      ...
      <section className="bg-gray-100 rounded-lg p-6 mt-8 mb-12">
      ...
      <section className="mt-16">
        ...
        <div className="rounded-2xl bg-purple-600 text-white text-center px-6 py-4 font-semibold shadow-sm max-w-3xl mx-auto mb-12">
      ...
      <section className="mt-16">
        ...
        {/* Problem */}
        <div className="mb-8">
          <h3 className="text-xl font-semibold text-red-500 mb-2">Problem</h3>
          <p className="text-base text-gray-700">
            Although the NFT market is rapidly expanding, most general users
            face difficulties due to complex concepts and unfriendly minting
            processes. As a result, participation is limited and mass adoption
            has been delayed.
          </p>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="text-base text-gray-700">
            Desk research revealed that while 45% of users aged 18–35 have heard
            of NFTs, only 20% understood blockchain technology. This indicates
            strong awareness but low comprehension, highlighting a need for more
