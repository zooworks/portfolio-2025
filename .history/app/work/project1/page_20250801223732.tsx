    ...
    <div className="px-6 py-10 max-w-4xl mx-auto">
      ...
      <section className="mt-16">
        ...
        <div className="mt-16">
          ...
          <p className="text-base text-gray-600 mb-8">
            This section visualizes the key UX strategy and information
            architecture, identifying core problems, design goals, and
          ...
          {/* Optional Second Image (IA Flow Chart) */}
          <div className="flex flex-col items-center">
            <img
              src="/IA_FlowChart.jpg"
              alt="Information Architecture Flow"
              className="mb-4 w-full rounded-lg shadow-lg"
            />
          </div>
        </div>
