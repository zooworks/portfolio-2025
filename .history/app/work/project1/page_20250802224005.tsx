      ...
      <section className="mt-16">
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-6">
            {[
              "Minimal differentiation in\ncommerce comparison",
              "Consistent decline in\nmarket curation",
              "Reviews lack\nobjectivity",
            ].map((text, idx) => (
              <div
                key={idx}
                className="flex items-center justify-center w-40 h-40 rounded-full border-2 border-gray-300 text-center text-gray-700 whitespace-pre-line leading-snug"
              >
                {text}
              </div>
            ))}
          ...
          <div className="flex flex-col gap-6 w-full max-w-3xl mx-auto">
            {/* Goal */}
            <div className="flex gap-4 items-center border border-gray-200 rounded-xl p-6 bg-white shadow-md">
            ...
            {/* UX Design */}
            <div className="flex gap-4 items-center border border-gray-200 rounded-xl p-6 bg-white shadow-md">
              <div className="w-20 h-20 flex items-center justify-center border-2 border-purple-500 text-purple-500 font-bold rounded-full text-xs text-center">
                UX DESIGN
              </div>
