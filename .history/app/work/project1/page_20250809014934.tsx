          ...
          <section className="mt-16">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group block rounded-xl border border-gray-200 overflow-hidden bg-white hover:shadow-md transition"
              >
                <img
                  src="/prototype1.jpg"
            ...
            <p className="text-xs text-gray-400 mt-3">
              *Click a card to open the full‑size wireframe.
            </p>
          </section>
        </section>
      </section>
