        ...
        <section className="mt-16">
          ...
          <section className="mt-16">
            ...
            <section className="mt-16">
              ...
              <section className="mt-6 md:mt-10" id="haemi-needs">
                ...
                {/* 모바일: gap을 아주 작게, 데스크톱: 웹 합본만 */}
                <div className="grid grid-cols-1 gap-y-0 sm:grid-cols-2 sm:gap-3 lg:hidden">
                  {[
                    ...
                    <img
                      ...
                      src={src}
                      alt=""
                      className="block w-full max-w-[420px] mx-auto rounded-xl"
                      loading="lazy"
                    />
                  ))}
                </div>
              ...
              {/* 모바일: gap을 아주 작게, 데스크톱: 웹 합본만 */}
              {/* 모바일: 두 장씩 균일 너비/비율 */}
              <div className="grid grid-cols-2 gap-2 lg:hidden max-w-[860px] mx-auto">
                {[
                  "/haemi-needs-point2-1.png",
                  "/haemi-needs-point2-2.png",
                  "/haemi-needs-point2-3.png",
                  "/haemi-needs-point2-4.png",
                ].map((src) => (
                  <div
                    key={src}
                    className="w-full aspect-[4/3] overflow-hidden rounded-xl" // 동일 비율 컨테이너
                  >
                    <img
                      src={src}
                      alt=""
                      className="h-full w-full object-cover" // 크롭해서 꽉 채우기
                      loading="lazy"
                    />
                  </div>
                ))}
