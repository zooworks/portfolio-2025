              ...
              <div className="mx-auto max-w-[860px] px-4">
                ...
                <section className="mt-6 md:mt-10">
                  ...
                  <div className="lg:hidden">
                    <div className="w-full max-w-[500px] mx-auto rounded-xl overflow-hidden aspect-[9/19]">
                      <img
                ...
                <section className="mt-6 md:mt-10">
                  ...
                  <div className="lg:hidden mt-4">
                    <img
                      ...
                      className="w-full max-w-[420px] mx-auto rounded-xl h-auto"
                      loading="lazy"
                    />
                  </div>
