  ...
  return (
    <div className="px-6 py-10 max-w-4xl mx-auto">
      ...
      <section className="mt-16">
        ...
        <div className="flex justify-center items-start gap-6 sm:flex-row flex-col">
          {[
            {
              title: "GOAL",
              text1: "“Lifestyle Curation”",
              text2:
                "Curating culinary experiences that define the user’s [Dining] Style.",
            },
            {
              title: "UX DESIGN",
              text1: "Data-driven recommendation features that build trust.",
              text2: "Improved usability to increase participation.",
            },
            {
              title: "FUNCTION",
              text1:
                "Reduce unnecessary icons and add friendly dining recommendation icons.",
              text2: "Reviews designed to be easy to scan at a glance.",
            },
          ].map((item, idx) => (
            <div
              key={idx}
              className="flex sm:flex-col flex-row items-center sm:w-auto w-full 
                 border border-gray-200 rounded-2xl p-4 sm:p-6 mb-4 sm:mb-0"
            >
              {/* 왼쪽 원형 (웹 그대로) */}
              <div
                className="flex items-center justify-center rounded-full border-2 border-purple-400 
                      text-purple-500 font-bold w-20 h-20 sm:w-28 sm:h-28 flex-shrink-0 mr-4 sm:mr-0"
              >
                {item.title}
              </div>

              {/* 오른쪽 텍스트 */}
              <div className="text-gray-700 text-base sm:text-sm text-left sm:text-center">
