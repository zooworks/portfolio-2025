      ...
      <section className="bg-gray-100 rounded-lg p-6 mb-12">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8">
          <div className="md:col-span-3">
            <h3 className="text-sm font-bold uppercase text-gray-600 mb-1">
              Role
            </h3>
          ...
          {/* Contribution: 제목 3칸 / 본문 9칸 */}
          <h3 className="text-sm font-bold uppercase text-gray-600 mb-2 md:col-span-3">
            Contribution
          </h3>
