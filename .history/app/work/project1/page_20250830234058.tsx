        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8">
          ...
          <div className="md:col-span-3">
            ...
            <p className="text-base text-gray-800">
              ...
              2 UI Designers <br />2 UX Researchers
            </p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6 sm:overflow-visible">
          {[
            ...
            <div key={idx} className="w-full sm:w-auto">
              <div className="hidden sm:flex items-center justify-center rounded-full border border-gray-300 text-center text-gray-700 p-4 w-40 h-40 sm:w-48 sm:h-48 text-sm sm:text-base flex-shrink-0">
                {text}
              </div>
              <div className="sm:hidden w-full text-center text-gray-700 text-base font-medium border border-gray-200 rounded-xl py-6 px-8 mb-0">
                ⚡ {text}
              </div>
            </div>
          ))}
