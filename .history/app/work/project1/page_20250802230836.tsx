...
<div className="flex flex-col gap-6 max-w-3xl mx-auto">
  ...
  {/* Goal */}
  <div className="flex gap-4 items-stretch border border-gray-200 rounded-xl p-6 bg-white shadow">
    <div className="flex items-center justify-center border-2 border-purple-500 text-purple-500 font-bold rounded-full aspect-square max-h-full flex-shrink-0">
      GOAL
    </div>
