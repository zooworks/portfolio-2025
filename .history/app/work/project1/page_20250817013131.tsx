            ...
            <section className="mt-16">
              ...
              <section className="mt-10" id="haemi-needs">
                ...
                <div className="flex gap-0">
                  <img src="/haemi-needs-point-1.png" className="w-1/4 -ml-1" />
                  <img src="/haemi-needs-point-2.png" className="w-1/4 -ml-1" />
                  <img src="/haemi-needs-point-3.png" className="w-1/4 -ml-1" />
                  <img src="/haemi-needs-point-4.png" className="w-1/4 -ml-1" />
                </div>
              </section>
