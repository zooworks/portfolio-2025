      ...
      <section className="mt-16">
        ...
        <div className="mt-16">
          ...
          <div className="flex flex-col gap-8 md:hidden">
            <div className="border border-gray-200 rounded-xl shadow p-4 bg-white">
              <img
                src="/Persona1.jpg"
                alt="User Persona - Go Yeon-hee"
...
<section className="mt-20">
  ...
  <div className="flex justify-center items-center gap-6 mb-6">
    {[
      ...
      <div
        key={idx}
        className="flex items-center justify-center w-40 h-40 rounded-full border border-gray-300 text-center text-gray-700 px-4 leading-snug"
      >
        {text}
      </div>
    ))}
  ...
  <div className="flex flex-col gap-6 max-w-3xl mx-auto">
    {/* Goal */}
    <div className="flex gap-4 items-start border border-gray-200 rounded-xl p-6 bg-white shadow-sm">
      <div className="w-20 h-20 flex items-center justify-center border-2 border-purple-500 text-purple-500 font-bold rounded-full">
        GOAL
      </div>
    ...
    <div className="flex gap-4 items-start border border-gray-200 rounded-xl p-6 bg-white shadow-sm">
      ...
      <ul className="flex-1 text-gray-600 leading-relaxed list-disc list-inside">
        <li>
    ...
    <div className="flex gap-4 items-start border border-gray-200 rounded-xl p-6 bg-white shadow-sm">
      ...
      <ul className="flex-1 text-gray-600 leading-relaxed list-disc list-inside">
        <li>
          Reduce unnecessary icons and add <b>friendly dining recommendation</b> icons.
        </li>
        <li>
