    ...
    <div className="px-6 py-10 max-w-6xl mx-auto">
      ...
      <section className="mb-12">
        <table className="w-full text-left border-separate border-spacing-y-2">
          <thead>
            <tr className="text-sm font-bold uppercase text-gray-600">
              <th className="pr-8">Role</th>
              <th className="pr-8">Team</th>
              <th className="pr-8">Timeline</th>
              <th className="pr-8">Tools</th>
            </tr>
          </thead>
          <tbody className="text-base text-gray-800">
            <tr>
              <td className="align-top">Product Design Lead</td>
              <td className="align-top">
                2 Product Designers <br />
                6 Engineers <br />1 Information Security Officer
              </td>
              <td className="align-top">
                Jan – Jun 2022 <br />
                (6 Months)
