  ...
  return (
    <div className="px-6 py-10 max-w-4xl mx-auto">
      ...
      <section className="mt-16">
        ...
        {/* Problem Circles / Boxes */}
        <div className="flex flex-col sm:flex-row justify-center items-center gap-6 sm:gap-6 overflow-x-auto w-full">
          {[
        ...
        sm:rounded-full sm:border sm:border-gray-300 sm:w-48 sm:h-48 sm:p-4 sm:text-center sm:text-gray-700
        flex-shrink-0
        w-full rounded-xl border border-gray-200 p-6 
        text-gray-700 text-base sm:text-base text-center flex items-center justify-center
      "
              dangerouslySetInnerHTML={{
                __html: text
                  .replace(
                    "differentiation",
                    "<span class='font-bold'>differentiation</span>"
                  )
                  .replace(
                    "market presence",
                    "<span class='font-bold'>market presence</span>"
                  )
                  .replace(
                    "Unintuitive reviews",
                    "<span class='font-bold'>Unintuitive reviews</span>"
                  ),
              }}
            />
          ))}
