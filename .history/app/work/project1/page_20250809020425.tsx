    ...
    <div className="px-6 py-10 max-w-4xl mx-auto">
      ...
      <section className="mt-16">
        ...
        <section className="mt-16">
          ...
          {/* 7. Wire Frames (STACK/EXPAND STYLE) */}
          <section className="mt-16">
            <h2 className="text-2xl font-bold mb-4 text-purple-600">
              7. Wire Frames
            </h2>
            ...
            <div className="space-y-4">
              ...
              <details className="group rounded-xl border border-gray-200 bg-white overflow-hidden">
                <summary className="cursor-pointer list-none p-4 sm:p-5 flex items-center justify-between">
                  <div>
                ...
                <div className="border-t border-gray-100">
                  <img
                    ...
                    loading="lazy"
                    className="w-full max-h-[720px] object-contain bg-gray-50"
                  />
