      ...
      <section className="mt-16">
        ...
        <div className="mt-16">
          ...
          <div className="flex justify-center">
            <div className="px-64 py-2 bg-purple-600 text-white font-semibold rounded-full">
              PROBLEM
            </div>
          </div>
          ...
          <div className="flex flex-col gap-6 max-w-3xl mx-auto">
            {/* Goal */}
            <div className="flex gap-4 items-stretch border border-gray-200 rounded-xl p-6 bg-white shadow max-w-3xl mx-auto">
              {/* Circle */}
              <div className="flex items-center justify-center border-2 border-purple-500 text-purple-500 font-bold rounded-full aspect-square w-40 h-40 flex-shrink-0">
                GOAL
              </div>
              ...
              <div className="flex flex-col justify-center flex-1">
                ...
                <p className="text-gray-600">
                  - Curating culinary experiences that define the user’s
                  [Dining] Style.
                </p>
              </div>
            </div>
            ...
            {/* UX Design */}
            <div className="flex gap-4 items-start border border-gray-200 rounded-xl p-6 bg-white shadow h-40">
              <div className="flex items-center justify-center border-2 border-purple-500 text-purple-500 font-bold rounded-full aspect-square h-full flex-shrink-0">
                UX DESIGN
              </div>
