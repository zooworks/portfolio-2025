          ...
          <section className="mt-16">
            ...
            <section className="mt-16">
              ...
              <section className="mt-10" id="haemi-needs">
                ...
                {/* 본문 */}
                <div className="grid grid-cols-1 gap-6">{/* 카드 4개 */}</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
                  ...
                  <div className="md:col-span-8">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                      ...
                      {[
                        {
                          src: "/haemi-meal-profile-01.jpg",
                          alt: "Meal Profile – category list",
                          cap: "Category-first allergy input",
                        },
                        {
                          src: "/haemi-meal-profile-02.jpg",
                          alt: "Fruit allergy multi-select",
                          cap: "Fruit allergy: multi-select with short helpers",
                        },
                        {
                          src: "/haemi-meal-profile-03.jpg",
                          alt: "My Kurly Style – profile completion",
                          cap: "Profile completion & privacy toggle",
                        },
                        {
                          src: "/haemi-meal-profile-04.jpg",
                          alt: "Profile saved feedback",
                          cap: "Clear “Profile saved” feedback",
                        },
                      ].map((item, idx) => (
                        <figure
                          key={idx}
                          className="rounded-2xl border border-gray-200 bg-white p-3 shadow-sm h-full flex flex-col"
                        >
                          <img
                            src={item.src}
                            alt={item.alt}
