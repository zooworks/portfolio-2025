            ...
            <section className="mt-16">
              ...
              <div className="grid md:grid-cols-2 gap-8 mt-10">
                ...
                <div className="border border-gray-200 rounded-xl p-6 bg-white shadow-sm">
                  ...
                  <img
                    src="/haemi-needs.jpg" // 👉 준비한 이미지 파일 경로
                    alt="Hae-Mi’s Needs Point"
                    className="rounded-lg shadow-md mb-4"
                  />
                  <p className="text-sm text-gray-600">
                    핵심 인사이트를 여기에 간단히 적어주면 좋아. 예: Hae-Mi는
                    빠르고 직관적인 리뷰 작성과 맞춤형 추천을 원한다.
                  </p>
                </div>
                ...
                <div className="border border-gray-200 rounded-xl p-6 bg-white shadow-sm">
                  ...
                  <img
                    src="/yeonhee-needs.jpg" // 👉 준비한 이미지 파일 경로
                    alt="Yeon-hee’s Needs Point"
                    className="rounded-lg shadow-md mb-4"
                  />
                  <p className="text-sm text-gray-600">
                    여기에도 간단한 설명. 예: Yeon-hee는 예산에 맞는 식단 제안과
                    커뮤니티 기반 리뷰 신뢰도를 중요시한다.
                  </p>
                </div>
              </div>
            </section>
