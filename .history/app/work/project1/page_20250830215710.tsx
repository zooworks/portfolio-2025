...
export default function Project1Page() {
      ...
      <section className="bg-gray-100 rounded-lg p-6 mb-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <p className="text-base text-gray-800">
              1 Product Designers <br />
              2 UI Designer <br />2 UX Researchers
            </p>
          </div>
          <div>
            <h3 className="text-sm font-bold uppercase text-gray-600 mb-2">
  ...
  <div className="mt-8 flex flex-col md:flex-row md:items-start md:gap-8">
    <h3 className="text-sm font-bold uppercase text-blue-600 w-full md:w-1/4">
      Contribution
    </h3>
    <div className="text-base text-gray-800 md:w-3/4">
      <p>
        As a product design lead, I successfully led the design of a
        B2B-focused fintech/health app into a user-friendly platform by:
      </p>
      <ul className="list-disc list-inside mt-3 space-y-2">
        <li>
          <span className="font-semibold">Managing the entire design process</span> from start to finish.
        </li>
        <li>
          <span className="font-semibold">Collaborating with cross-functional teams</span> to align goals and deliverables.
        </li>
        <li>
          <span className="font-semibold">Creating a new design system</span> that improved usability.
        </li>
      </ul>
    </div>
  </div>
